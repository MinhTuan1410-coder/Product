...
CREATE TABLE accounts (
    ...
    phone NVARCHAR(20),
    isUse BIT DEFAULT 0,           -- 1: active | 0: blocked
    roleInSystem INT DEFAULT 0     -- 1: admin | others: staff
)
GO
...
CREATE TABLE products (
    ...
    account VARCHAR(20) NOT NULL
        FOREIGN KEY REFERENCES accounts(account)
        ON UPDATE CASCADE,
...
-- Xóa sản phẩm thuộc category đó
